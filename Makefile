...
# architectures. (i.e. make docker-buildx IMG=myregistry/mypoperator:1.0.0). To use this option you need to:
...
$(CONTROLLER_GEN): $(LOCALBIN)
	...
	GOSUMDB=off GOBIN=$(LOCALBIN) go install sigs.k8s.io/controller-tools/cmd/controller-gen@$(CONTROLLER_TOOLS_VERSION)
